...
public class SMCifsProperty extends SMBatchProperty {
	...
	public SMCifsProperty(boolean defValue) {
		...
		cifs = new SMModuleProperty("cifs", "/system/lib/modules/cifs", false);
		md4 = new SMModuleProperty("md4", "/system/lib/modules/md4", false);
		nls_utf8 = new SMModuleProperty("nls_utf8", "/system/lib/modules/nls_utf8", false);
	}
}
