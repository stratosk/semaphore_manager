...
public class SemaI9000Properties extends SemaCommonProperties {
	...
	public SemaI9000Properties() {
		...
		radio_si4709_i2c = new SMModuleProperty("radio_si4709_i2c", "/system/lib/modules/radio-si4709-i2c", false);
		mousedev = new SMModuleProperty("mousedev", "/system/lib/modules/mousedev", false);
	...
	public void getPreferences(Context context) {
		...
		ondemand.smooth_ui.setValue(prefs.getBoolean(ondemand.smooth_ui.getName(), ondemand.smooth_ui.getDefBoolean()) ? 1 : 0);
		...
		smartass.smooth_ui.setValue(prefs.getBoolean(smartass.smooth_ui.getName(), smartass.smooth_ui.getDefBoolean()) ? 1 : 0);
		...
		deep_idle.setValue((prefs.getBoolean(deep_idle.getName(), deep_idle.getDefBoolean()) ? 1 : 0));
		deep_idle_stats.setValue((prefs.getBoolean(deep_idle_stats.getName(), deep_idle_stats.getDefBoolean()) ? 1 : 0));
		lock_min.setValue((prefs.getBoolean(lock_min.getName(), lock_min.getDefBoolean()) ? 1 : 0));
		bluetooth.setValue((prefs.getBoolean(bluetooth.getName(), bluetooth.getDefBoolean()) ? 1 : 0));
		...
		bigmem.setValue(prefs.getBoolean(bigmem.getName(), bigmem.getDefBoolean()) ? 1 : 0);
		wififast.setValue(prefs.getBoolean(wififast.getName(), wififast.getDefBoolean()) ? 1 : 0);
		forcefastchg.setValue(prefs.getBoolean(forcefastchg.getName(), forcefastchg.getDefBoolean()) ? 1 : 0);
